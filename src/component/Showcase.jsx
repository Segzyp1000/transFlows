...
function Showcase() {
  return (
    <div>
      <section
        className="wrappers flex flex-col max-w-full p-6 space-y-0 mt-36"
        id="home"
      >
        <div className="flex flex-col mb-32 mt-20 xsm:mx-0 sm:mx-0 md:mx-12 space-y-12 md:w-1/2">
          <p className="max-w-sm text-center bg-whitishBackground text-whiteishGray">
          ...
          <a
            href="#"
            className="max-w-sm text-center p-3 pt-2 px-6  text-white bg-lightYellow hover:bg-gray-500"
          >
            Explore More
          </a>
        </div>
